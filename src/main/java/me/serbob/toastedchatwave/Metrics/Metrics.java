package me.serbob.toastedchatwave.Metrics;
...
public class Metrics {
    ...
    public Metrics(JavaPlugin plugin, int serviceId) {
        ...
        metricsBase =
            new MetricsBase(
                ...
                submitDataTask -> FoliaScheduler.getGlobalRegionScheduler().run(plugin, (ignored) -> submitDataTask.run()),
                plugin::isEnabled,
    ...
    public static class MetricsBase {
        ...
        private void startSubmitting() {
            final Runnable submitTask =
                () -> {
                    ...
                    FoliaScheduler.getAsyncScheduler().runNow(plugin, (ignored) -> submitData());
                };
            ...
            FoliaScheduler.getAsyncScheduler().runDelayed(plugin, (ignored) -> submitTask.run(), initialDelay, TimeUnit.MILLISECONDS);
            FoliaScheduler.getAsyncScheduler().runAtFixedRate(plugin, (ignored) -> submitTask.run(), initialDelay + secondDelay, 1000 * 60 * 30, TimeUnit.MILLISECONDS);
        }
        ...
        private void submitData() {
            ...
            FoliaScheduler.getAsyncScheduler().runNow(plugin, (ignored) -> {
                try {
                    sendData(data);
                } catch (Exception e) {
